...
8. For infrastructure changes (CDK, Terraform, CI/workflow config, Kubernetes), run a quick validation pass early when feasible — for example, \`cdk synth\`, typecheck, or the closest equivalent — before deeper review.
